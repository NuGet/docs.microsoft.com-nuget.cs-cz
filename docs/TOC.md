...
### [Poradce při potížích](consume-packages/package-restore-troubleshooting.md)
...
## [Podpora více cílových verzí rozhraní](create-packages/supporting-multiple-target-frameworks.md)
...
## [Cílová rozhraní](reference/target-frameworks.md)
...
### [Hledat](api/search-query-service-resource.md)
...
## [Omezení rychlosti](api/rate-limits.md)
## [Protokoly nuget.org](api/nuget-protocols.md)
## [tools.json](api/tools-json.md)
# Rozšiřitelnost sady Visual Studio
## [Rozhraní API NuGetu v sadě Visual Studio](visual-studio-extensibility/nuget-api-in-visual-studio.md)
