...
1. Všimněte si, že **zahrnují preprelease** a **zdroj balíčku** ovládací prvky mít žádný vliv, při odinstalaci balíčků.
...
V tomto příkladu je projektu ClassLibrary1 využitím objektu EntityFramework 6.2.0, zatímco ConsoleApp1 je s využitím objektu EntityFramework 6.2.0. Pro konsolidaci verze balíčku, postupujte takto:
