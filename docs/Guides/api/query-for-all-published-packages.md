...
Poté, co jste si stáhli všechny stránky katalogu není odfiltrovat, budete mít sadu objektů typu list katalogu představující balíčky, které byly publikované, neuvedené, seznamu nebo odstraněných v době mezi vaší kurzoru časové razítko a teď.
