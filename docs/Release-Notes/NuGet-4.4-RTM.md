...
---
# <a name="44-rtm-release-notes"></a>4.4 poznámky k verzi RTM
...
* Prosté řešení zatížení: Běžné jádra pro PM uživatelského rozhraní, pomocí PMC a inicializační vektory * - [#5057](https://github.com/NuGet/Home/issues/5057)
...
## <a name="link-to-github-issues-fixed-in-44-rtm"></a>Odkaz na Githubu chyby v 4.4 RTM
